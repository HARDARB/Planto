...
//   const { addToCart, toggCart, cart } = useCart(); // ✅ use cart instead of cartItems
...
//         className="mt-3 bg-green-600 px-4 py-2 rounded-xl hover:bg-green-700 text-white"
//       >
//         Buy Now
//       </button>
...
//   const { addToCart, toggCart, cart } = useCart(); // ✅ include cart
...
//       <button
//         onClick={() => addToCart(product)}
//         className="border border-white px-5 py-2 rounded-lg hover:bg-green-600 hover:text-white transition text-white"
//       >
//         Buy Now
//       </button>
